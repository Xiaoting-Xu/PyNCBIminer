...
################################################################################
## Form generated from reading UI file 'PyNCBIminer_main9.ui'
##
...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        sizePolicy3.setHeightForWidth(self.taxonomy.sizePolicy().hasHeightForWidth())
        self.taxonomy.setSizePolicy(sizePolicy3)
        ...
        self.target_region.setFont(font3)
        ...
        self.horizontalLayout_31.addWidget(self.control_extension)
        ...
        sizePolicy4.setHeightForWidth(self.run_filtering.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy5.setHeightForWidth(self.ali_thr.sizePolicy().hasHeightForWidth())
        self.ali_thr.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.ali_reo.sizePolicy().hasHeightForWidth())
        self.ali_reo.setSizePolicy(sizePolicy5)
        ...
        sizePolicy4.setHeightForWidth(self.run_alignment.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy5.setHeightForWidth(self.tri_met.sizePolicy().hasHeightForWidth())
        self.tri_met.setSizePolicy(sizePolicy5)
        ...
        sizePolicy4.setHeightForWidth(self.run_trimming.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.control_extension.setText(QCoreApplication.translate("MainWindow", u"Control extension", None))
        self.reduce_dataset.setText(QCoreApplication.translate("MainWindow", u"Reduce dataset", None))
