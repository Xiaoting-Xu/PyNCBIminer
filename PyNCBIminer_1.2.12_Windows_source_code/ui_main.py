...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        sizePolicy3.setHeightForWidth(self.consensus_value.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy6.setHeightForWidth(self.run_concatenation.sizePolicy().hasHeightForWidth())
